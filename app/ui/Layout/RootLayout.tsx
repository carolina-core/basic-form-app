...
const navigation = [
  ...
  { name: 'Manage Forms', href: '/forms', icon: ClockIcon, current: false },
  { name: 'Questions', href: '/questions', icon: ClockIcon, current: false },
  { name: 'Manage Requests', href: '/requests', icon: ScaleIcon, current: false },
]
